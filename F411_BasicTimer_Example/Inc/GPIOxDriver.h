...
/* Valores estándares para las configuraciones */
...
/*GPIOx_IDR (un bit por PIN) - este es el registro para leer el estado de un pin */

/*8.4.5 GPIOx_DDR (un bit por PIN) - este es el registro para escribir el estado de un PIN
 * (1 o 0). Este registro puede ser escrito y leído desde el software, pero no garantiza una
 * escritura "atómica", por lo que es preferible utilizar el registro BSRR
 */
...
typedef struct
{
	...
	uint8_t GPIO_PinOType;			// Trabaja de la mano con el anterior, selecciona salida PUPD o OpenDrain
 ...
 * - La dirección del puerto que se está utilizando (la referencia del puerto)
...
/* Definición de las cabeceras de las funciones GPIOxDriver */
